...
Sample Dynatree options to use this service:
        $("#tree").dynatree({
            ...
            initAjax: {url: "http://127.0.0.1:8001",
                       dataType: "jsonp", // Enable JSONP, so this sample can be run from the local file system against a localhost:8888 server
                       data: {key: "",
//                              sleep: 3,
//                              depth: 2,
                              mode: "baseFolders"
...
#    hostname = "127.0.0.1" # Use empty string for localhost:8888 (local access only)
