...
<div class="col-sm-4">
<input type="text" name="noc" required="required" value="" required="" class="form-control" style="box-sizing: border-box;
    margin: 0;
    overflow: visible;
    display: block;
    width: 100%;
...
<input style="box-sizing: border-box;
    ...
    height: 48px;
    "
 type="file" name="compfile" class="form-control" value="">
</div>
</div>
