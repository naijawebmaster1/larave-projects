                ...
                <div
                    ...
                    <table class="min-w-full">
                        ...
                        <tbody class="bg-white"> @for($i = 0; $i < count($data); $i++) <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-500">
                                    <div class="text-sm leading-5 text-blue-900">{{ $data[$i]['id'] }}</div>
                                </td>
                                <td
                                    class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                                    {{ $data[$i]['temperatureF'] }}</td>
                                <td
                                    class="px-6 py-4 whitespace-no-wrap border-b text-blue-900 border-gray-500 text-sm leading-5">
                                    {{ $data[$i]['temperatureC'] }}</td>
                                ...
                                <td
                                    ...
                                    <a onclick="alert('Appointment Submitted');" href="https://prioclen.ng/demo.php"><button
                                            class="px-5 py-2 border-indigo-900 border rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none bg-indigo-700 text-white">Book Appointment</button>
                                    </a>
                                </td>
                                </tr> @endfor </tbody>
                    </table>
